...
func main() {
    ...
    creattagurl()
    newfilename()
    newname = strconv.FormatInt(i+1,10) + ".htm"
    fmt.Printf("%s\n",newname)
    readmode()
    texttohtml()
    writefile()
...
func texttohtml() {    
    ...
    meta := "</div><div class=\"meta\">Written on " + time + " | Tag: <a href=\"../" + tagurl + ".htm\">" + tag + "</a>"
